		...
		<div className="mx-auto max-w-5xl space-y-8 py-8">
			...
			<div className="rounded-2xl border border-white/10 bg-slate-900/60 p-8 shadow-xl">
				...
				<div className="space-y-4 text-slate-200">
					<p className="text-lg">
						The Gathering Call was created with a simple but powerful
						vision: to help gamers find each other for epic tabletop
						adventures. We believe that everyone should have access to
						amazing gaming experiences, regardless of their budget.
					</p>
					<p className="text-lg">
						This isn&apos;t a money grab. This is about building a
						thriving community where Game Masters and players can connect,
						create memorable stories, and share their passion for tabletop
						gaming.
					</p>
				</div>
			</div>
					...
					<ul className="space-y-4">
						<li className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-slate-300">
									Free games will always be an option on The Gathering
									Call. If we can&apos;t operate while offering free
									games, we will shut down rather than force everyone
									to pay.
								</p>
							</div>
						</li>
						<li className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-slate-300">
									Our 15% platform fee is significantly lower than
									other platforms. We keep fees minimal because this is
									about supporting the community, not maximizing
									profits.
								</p>
							</div>
						</li>
						<li className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-slate-300">
									We&apos;re honest about our fees and where they go:
									supporting infrastructure, development, and scaling
									to serve more gamers.
								</p>
							</div>
						</li>
						<li className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-slate-300">
									Your feedback shapes our platform. We listen to Game
									Masters and players to build the features you
									actually need.
								</p>
							</div>
						</li>
					...
					<ul className="space-y-4">
						<li className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-slate-300">
									Tabletop games create bonds, tell stories, and build
									communities. We&apos;re here to facilitate those
									connections.
								</p>
							</div>
						</li>
						<li className="flex items-start gap-3">
							...
							<div>
								<p className="text-slate-100 font-semibold">
									Game Masters Deserve Support
								</p>
								<p className="text-sm text-slate-300">
									Running games takes time, creativity, and effort. GMs
									should have the option to be compensated fairly for
									their work while keeping fees reasonable.
								</p>
							</div>
						</li>
						<li className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-slate-300">
									Whether you&apos;re looking for free games or willing
									to pay for premium experiences, there&apos;s a place
									for you here.
								</p>
							</div>
						</li>
						<li className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-slate-300">
									We focus on building tools that truly help gamers
									connect and organize sessions, not on flashy features
			...
			<div className="rounded-2xl border border-white/10 bg-slate-900/60 p-8 shadow-xl">
				...
				<div className="space-y-4 text-slate-300">
					<p>
						We believe in transparency. Here&apos;s the truth about
						platform fees:
					</p>
					...
					<p className="text-center text-amber-300 font-semibold mt-6">
						💰 Our lower fees mean more money for Game Masters and better
						value for players!
					</p>
				</div>
			</div>
			...
			<div className="rounded-2xl border border-white/10 bg-slate-900/60 p-8 shadow-xl">
				...
				<p className="text-slate-300 text-center max-w-3xl mx-auto">
					The Gathering Call is proudly developed and maintained by
					Midnight Oil Software LLC, a company operated by a gamer, and
					we&apos;re committed to creating platforms that reflect our
					values: community, accessibility, and fair treatment for
					everyone.
				</p>
			</div>
			...
			<div className="rounded-2xl border border-indigo-500/50 bg-slate-900/60 p-8 shadow-xl">
				...
				<div className="space-y-4 text-slate-300">
					<p>
						Our fees exist to support the platform&apos;s future growth.
						As more gamers join The Gathering Call, we need to:
					</p>
					<ul className="space-y-3 ml-6">
						<li className="flex items-start gap-3">
							<span className="text-indigo-400 mt-1">•</span>
							<span>
								Scale our infrastructure to handle more users and
								sessions
							</span>
						</li>
						<li className="flex items-start gap-3">
							<span className="text-indigo-400 mt-1">•</span>
							<span>
								Continue developing new features requested by the
								community
							</span>
						</li>
						<li className="flex items-start gap-3">
							<span className="text-indigo-400 mt-1">•</span>
							<span>
								Provide reliable support for Game Masters and players
							</span>
						</li>
						<li className="flex items-start gap-3">
							<span className="text-indigo-400 mt-1">•</span>
					...
					<p className="text-sm text-slate-400 italic mt-4">
						Every dollar we collect goes right back into making The
						Gathering Call better for the entire community.
					</p>
				</div>
			</div>
			...
			<div className="rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-8 shadow-xl text-center">
				...
				<p className="text-slate-200 mb-6 max-w-2xl mx-auto">
					Whether you&apos;re a Game Master looking to host sessions or a
					player seeking your next adventure, The Gathering Call is here
					for you.
				</p>
