  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-8 text-slate-100">
      ...
      <header className="space-y-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-100">{session.game}</h1>
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm">
          ...
          <div className="rounded-lg border border-slate-800 bg-slate-900/70 px-4 py-2">
            ...
            <span className={`text-base font-medium ${isFull ? "text-orange-400" : "text-green-400"}`}>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-slate-100">Game Master</h2>
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-100">Signed Up Players</h2>
      ...
      {(waitlistPlayersList.length > 0 || isFull) && (
        <section className="space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-slate-100">Waitlist</h2>
            <span className="text-sm text-slate-400">
              {waitlistPlayersList.length} {waitlistPlayersList.length === 1 ? "player" : "players"}
            </span>
          </div>
