...
import {
	SKILL_ATTRIBUTES,
	getSkillDisplayName,
} from "@/lib/characters/skill-attributes";
...
const ROLE_OPTIONS = ["Healer", "Damage", "Caster", "Support", "DM", "Other"];
...
export default function CharactersPage() {
	...
	const handleImportJson = () => {
		...
		setFeedbackMessage(
			"Character data imported successfully from Pathbuilder2e!"
		);
		setActionError(null);
	};
		...
		<section className="space-y-6">
			...
			<div className="space-y-2">
				...
				<p className="text-sm text-slate-300">
					Craft, review, and iterate on the heroes and villains that bring
					your campaigns to life. Choose a supported game system or build
						...
						<div className="grid gap-4 md:grid-cols-2">
										...
										>
											<div>
												...
												<p className="text-xs text-indigo-300/80">
													Import character data from Pathbuilder2e
													JSON export
												</p>
											</div>
										...
										{showJsonImport && (
											<div className="mt-4 space-y-3">
												<div className="rounded-md bg-slate-900/50 p-3 text-xs text-slate-300">
													...
													<ol className="list-decimal list-inside space-y-1">
														<li>
															Open your character in
															Pathbuilder2e
														</li>
														<li>
															Tap the menu (three dots) and
							...
							{character.pdfUrls && character.pdfUrls.length > 0 ? (
								<div className="md:col-span-2 space-y-4">
									...
									>
										<h2 className="text-lg font-semibold text-slate-100">
											Character Details (Race, Background, etc.)
										</h2>
										<span className="text-xs uppercase tracking-wide text-slate-400">
