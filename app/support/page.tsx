		...
		<div className="mx-auto max-w-5xl space-y-8 py-8">
			<div className="rounded-3xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-8 shadow-2xl">
				<div className="text-center space-y-4">
					...
					<p className="text-slate-200 max-w-2xl mx-auto">
						Find answers quickly, explore platform resources, and connect
						with our team whenever you need help.
					</p>
				</div>
			</div>
			...
			<section className="rounded-2xl border border-white/10 bg-slate-900/60 p-8 shadow-xl">
				...
				<p className="mt-3 text-sm text-slate-300">
					Browse our guides and policy pages to learn how The Gathering
					Call supports Game Masters and players alike.
				</p>
			...
			<section className="rounded-2xl border border-white/10 bg-slate-900/60 p-8 shadow-xl">
				...
				<p className="mt-3 text-sm text-slate-300">
					Join our community server to get live help from The Gathering
					Call team and fellow GMs.
				</p>
				...
				<div className="mt-6 grid gap-6 md:grid-cols-2">
					<div className="rounded-xl border border-indigo-500/30 bg-indigo-500/10 p-5">
						...
						<p className="mt-2 text-sm text-slate-100/80">
							Reach out from your in-app Messages by starting a
							conversation with our support team. We typically respond
					...
					<div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-5">
						...
						<p className="mt-2 text-sm text-slate-100/80">
							...
							<a
								className="text-emerald-100 underline decoration-emerald-300/60 underline-offset-4 transition hover:text-emerald-50"
								href="mailto:support@thegatheringcall.com"
							>
								support@midnightoil.software
							</a>{" "}
							for billing, account, or policy questions.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-8 text-center shadow-2xl">
				...
				<p className="mt-3 text-sm text-slate-200 max-w-2xl mx-auto">
					Whether you&apos;re launching a new campaign, exploring paid
					games, or joining your first session, our team is ready to
					support your journey on The Gathering Call.
				</p>
			</section>
		</div>
	);
