			...
			<section className="space-y-10">
				...
				<header className="space-y-2">
					...
					<p className="max-w-2xl text-sm text-slate-300">
						Share the essential details about who you are, what you play,
						and when you are available. This form captures everything
						needed for other players and groups to connect with you.
					</p>
				</header>
				...
				<form className="space-y-12" onSubmit={handleSubmit}>
					...
					<section className="grid gap-6 rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-6 shadow-lg shadow-slate-900/30 md:grid-cols-2">
						...
						<div className="space-y-2">
							...
							/>
							<p className="text-xs text-slate-400">
								Optional. Used for SMS notifications from campaign
								hosts. For privacy, your phone number is never displayed
								after saving.{" "}
								<Link
									href="/sms-consent"
						...
						<div className="flex items-center justify-between gap-4">
							<div>
								...
								<p className="text-sm text-slate-400">
									Tell other players about yourself. Markdown
									formatting is supported for headings, emphasis, and
									lists.
								</p>
							</div>
					...
					<section className="space-y-3 rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-6 shadow-lg shadow-slate-900/30">
						<div className="flex items-center justify-between gap-4">
							<div>
								...
								<p className="text-sm text-slate-400">
									Describe your play style and what you enjoy most at
									the gaming table.
								</p>
							</div>
							<span className="text-xs text-slate-500">
					...
					<section className="space-y-3 rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-6 shadow-lg shadow-slate-900/30">
						<div className="flex items-center justify-between gap-4">
							<div>
								...
								<p className="text-sm text-slate-400">
									Describe your ideal gaming environment and what you
									look for in a table.
								</p>
							</div>
							<span className="text-xs text-slate-500">
					...
					<section className="space-y-4 rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-6 shadow-lg shadow-slate-900/30">
						<div className="space-y-1">
							...
							<p className="text-sm text-slate-400">
								Select your gaming preferences to help others find
								compatible players.
							</p>
						</div>
					...
					<section className="space-y-4 rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-6 shadow-lg shadow-slate-900/30">
						<div className="space-y-1">
							...
							<p className="text-sm text-slate-400">
								Select the game styles and formats you prefer or are
								comfortable with.
							</p>
						</div>
							...
							<div className="space-y-3">
								<div className="flex gap-2">
									<input
										...
										onChange={(e) =>
											setCustomGameInput(e.target.value)
										}
										onKeyDown={(e) => {
											if (e.key === "Enter") {
												e.preventDefault();
					...
					<section className="space-y-4 rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-6 shadow-lg shadow-slate-900/30">
						<div className="space-y-1">
							...
							<p className="text-sm text-slate-400">
								Choose your go-to systems from the games above.
								Favorites are only available after selecting the base
								game.
							</p>
						</div>
							...
							{DAYS_OF_WEEK.map((day) => (
								<div key={day} className="space-y-3">
									<div className="flex items-center justify-between">
										...
										<span className="text-xs text-slate-500">
											{availability[day]?.length ?? 0} hour(s)
											selected
										</span>
									</div>
									<div className="space-y-3">
					...
					<section className="space-y-4 rounded-2xl border-2 border-amber-500/50 bg-gradient-to-br from-amber-600/20 via-purple-600/20 to-indigo-600/20 p-6 shadow-lg shadow-slate-900/30">
						<div className="space-y-1">
							...
							<p className="text-sm text-slate-400">
								Indicate if you are a Game Master, Dungeon Master, or
