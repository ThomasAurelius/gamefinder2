...
export default function WaitlistPlayersList({
  sessionId,
  sessionType,
  players,
  isHost,
  onPlayerRemoved,
}: WaitlistPlayersListProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-md rounded-lg border border-slate-800 bg-slate-900 p-6">
            ...
            <p className="text-slate-300 mb-4">
              You are about to remove <strong>{selectedPlayer.name}</strong> from the waitlist.
